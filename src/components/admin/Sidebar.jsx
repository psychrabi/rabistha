		...
		<aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
			...
			<div class="flex flex-col justify-between flex-1 mt-6">
				<nav class="flex-1 -mx-3 space-y-3 ">
					...
					<Link class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" to="/rabistha/admin/dashboard">
				...
				<div class="mt-6">
					...
					<div class="flex items-center justify-between mt-6">
						...
						<button class="text-gray-500 transition-colors duration-200 rotate-180 dark:text-gray-400 rtl:rotate-0 hover:text-blue-500 dark:hover:text-blue-400" onClick={() => handleLogout()}>
