    ...
    <section className="w-full p-6 overflow-y-auto">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex items-center mt-4 gap-x-3">
          ...
          <button type="button" onClick={() => globalThis.location = "/admin/dashboard"} className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
