    ...
    <div>
        ...
        <div className="container px-6 py-16 mx-auto">
          <div className="items-center lg:flex">
            ...
            <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
              <img className="w-full h-full lg:max-w-3xl" src="images/6_monitors_one_comp.png" alt="Catalogue-pana.svg" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="items-center lg:flex">
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                <h2 className="text-2xl font-semibold text-gray-800 lg:text-3xl">Using the program</h2>
            ...
            <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
              <img className="w-full h-full lg:max-w-2xl" src="images/work_study_internet_dark.png" alt="Catalogue-pana.svg" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-6 py-16 mx-auto">
          ...
          <div className="items-center lg:flex">
            <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2 flex-col">
              <img className="w-1/2 h-full lg:max-w-2xl" src="images/monitor.png" alt="Catalogue-pana.svg" />
              <img className="w-full h-full lg:max-w-2xl" src="images/usb_hdmi_dvi_vga_wifi.svg" alt="Catalogue-pana.svg" />
            </div>
            <div className="w-full lg:w-1/2">
      ...
      <section className="bg-white">
        <div className="container px-6 py-16 mx-auto">
          <div className="items-center lg:flex">
            ...
            <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2 flex-col">
              <img className="w-full h-full lg:max-w-2xl" src="images/multiuser.png" alt="Catalogue-pana.svg" />
            </div>
          </div>
        </div>
      </section>
      <section>
        <div className="container px-6 py-16 mx-auto">
          <div className="items-center lg:flex">
            <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2 flex-col">
              <img className="w-full h-full lg:max-w-2xl" src="images/multiseat.png" alt="Catalogue-pana.svg" />
            </div>
            <div className="w-full lg:w-1/2">
