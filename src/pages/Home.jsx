...
function Home() {
  ...
  return (
    <div>
      <section>
        <div className="container px-6 py-16 mx-auto">
          <div className="items-center lg:flex">
            <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2 lg:order-2">
              <img className="w-full h-full lg:max-w-3xl" src="images/6_monitors_one_comp.png" alt="ASTER 6 workplaces from one system" />
            </div>
            <div className="w-full lg:w-1/2 lg:order-1 sm:mt-10">
              <div className="lg:max-w-xl">
                ...
                <button type="button" className="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500" onClick={() => handleDownload()}>Get a free trial Now</button>
              </div>
            </div>
      ...
      <Download />
      {showTestimonials === true ? <Testimonials /> : ''}
    </div>
  );
}
export default Home;