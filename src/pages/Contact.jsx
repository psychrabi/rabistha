    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="container px-6 py-12 mx-auto">
        <div>
          ...
          <p class="mt-3 text-gray-500 dark:text-gray-400">We’d love to hear from you. Please fill out this form or shoot us an email.</p>        </div>
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
          <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
            <div className="text-center">
              ...
              <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Have a question or issue, drop us an email.</p>
              <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">support@aster.com.np</p>
            </div>
            <div className="text-center">
              <span class="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                <MessageCircle />
              ...
              <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Have a question or issue, chat with us.</p>
            ...
            <div className="text-center">
              ...
              <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+977 9813098760</p>
              <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+977 9860240841</p>
            </div>
          </div>
          <div class="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
            <form>
              ...
              <div class="mt-4">
                ...
                <input type="email" placeholder="Email address" class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
              </div>
              <div class="w-full mt-4">
                <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Message</label>
                <textarea class="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Your message goes here."></textarea>
              </div>
