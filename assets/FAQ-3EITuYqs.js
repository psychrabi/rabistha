import{j as e}from"./index-gvpuhZWx.js";import{D as i}from"./Download-BC08x8P9.js";const n=[{title:"How do I know if my computer support creating multiple workplace?",content:"Does your computer have additional video port to connect an additional monitor or TV ? Then yes, you can create additional workplace from your computer."},{title:"Is Windows 10 operating system supported by ASTER?",content:"Yes, ASTER support Windows 7/8/10/11, Windows Server 2016/2019/2022/2025. However, ASTER doesnot support any preview builds of for Windows and Windows Server"},{title:"How many users can ASTER support?",content:"ASTER can support up to 12 users simultaneously, depending on the hardware configuration and available resources."},{title:"What are the system requirements for ASTER?",content:'ASTER requires a Windows operating system (Windows 7/8/10/11, Windows Server 2016/2019/2022/2025) and a compatible hardware configuration that includes a CPU, RAM, and video outputs to connect multiple monitors. For detailed requirements, please refer to the "System Requirements" section in the ASTER documentation.'},{title:"How do I install ASTER?",content:"To install ASTER, download the installation package from the official website, run the installer, and follow the on-screen instructions. Make sure to have administrative privileges during installation."},{title:"Can I use ASTER with virtual machines?",content:"Yes, ASTER can be used with virtual machines, but performance may vary depending on the virtualization software and hardware resources allocated to the virtual machine."},{title:"How do I configure ASTER for multiple users?",content:"After installing ASTER, you can configure it for multiple users by accessing the ASTER Control Panel. From there, you can add additional users, assign monitors to each user, and customize settings for each workplace."},{title:"What is the difference between ASTER Pro and ASTER Annual licenses?",content:"ASTER Pro is designed for professional use with advanced features and support for more users, while ASTER Home is intended for personal use with basic features and a limited number of users."},{title:"How do I troubleshoot common issues with ASTER?",content:'Common issues with ASTER can often be resolved by checking the hardware connections, ensuring that the video drivers are up to date, and reviewing the settings in the ASTER Control Panel. For specific troubleshooting steps, refer to the "Troubleshooting" section in the ASTER documentation.'},{title:"How do I get support for ASTER?",content:"You can get support for ASTER by visiting the official website and accessing the support section. There, you can find documentation, FAQs, and contact information for technical support."},{title:"Can I use ASTER with different types of monitors?",content:"Yes, ASTER supports various types of monitors, including LCD, LED, and CRT monitors. However, it is recommended to use monitors with compatible resolutions and refresh rates for optimal performance."},{title:"How do I activate ASTER?",content:'To activate ASTER, you need to enter the activation key provided with your purchase. This can be done through the ASTER Control Panel under the "Activation" section. Make sure you have an internet connection during the activation process.'},{title:"Can I use ASTER on a laptop?",content:"Yes, ASTER can be used on laptops, but it is important to ensure that the laptop has sufficient hardware resources and video outputs to support multiple monitors."},{title:"What is the maximum number of monitors that can be connected with ASTER?",content:"The maximum number of monitors that can be connected with ASTER depends on the hardware configuration and the number of available video outputs. Typically, ASTER supports up to 12 monitors, but this may vary based on the specific setup."},{title:"Can I use ASTER with remote desktop applications?",content:"Yes, ASTER can be used with remote desktop applications, allowing users to access their workplaces remotely while maintaining the multi-user functionality."},{title:"How do I uninstall ASTER?",content:'To uninstall ASTER, go to the Control Panel, select "Programs and Features," find ASTER in the list of installed programs, and click "Uninstall." Follow the prompts to complete the uninstallation process.'},{title:"Is there a trial version of ASTER available?",content:"Yes, a trial version of ASTER is available for download from the official website. The trial version allows you to test the software with limited features for a specified period."},{title:"Is it easy to setup?",content:"ASTER has a wizard which starts once you have installed ASTER, which will help you to setup the workplaces."},{title:"How can I transfer the license to another computer?",content:"You should perform the deactivation procedure from ASTER Control to deactivate the license. Once deactivation has been confirmed in ASTER Control, you will get a new key to use on your new computer."},{title:"Can I use ASTER for gaming setups?",content:"Yes, ASTER can be used for gaming setups where multiple users want to play games on the same PC. However, performance will depend on your hardware resources, especially the graphics card and CPU. Some games may require additional configuration for controllers or network settings."},{title:"Does ASTER support audio separation for each workplace?",content:"Yes, ASTER supports audio separation. You can assign different audio devices (such as USB sound cards or headsets) to each workplace, allowing each user to have independent audio output."},{title:"Can I use different languages or keyboard layouts for each workplace?",content:"Yes, each workplace can have its own language and keyboard layout settings. Configure these in the Windows settings for each user account."},{title:"Is there a limit to the number of USB devices per workplace?",content:"There is no strict software limit, but the number of USB devices per workplace is limited by your hardware (number of USB ports and controllers). Each workplace can use its own keyboard, mouse, and other USB peripherals."},{title:"Can I use ASTER in a school or classroom environment?",content:"Yes, ASTER is widely used in schools, classrooms, and training centers to maximize computer usage and reduce costs. Each student can have their own workplace using a single PC."},{title:"How do I update ASTER to the latest version?",content:"To update ASTER, download the latest installer from the official website and run it. Your license will remain valid if you are within the free upgrade period or have purchased an upgrade license."},{title:"What happens if my hardware changes after activation?",content:"Significant hardware changes (such as replacing the motherboard or CPU) may require reactivation of your ASTER license. Use the deactivation feature before making hardware changes, or contact support if you are unable to deactivate in advance."},{title:"Can I use ASTER with macOS or Linux?",content:"No, ASTER is designed for Windows operating systems only. But, recently we have added support for some linux distribution like Ubuntu, Debian, Fedora, etc."},{title:"Is technical support available in languages other than English?",content:"Technical support is primarily provided in English and Russian. User interface is available in multiple languages. For other languages, please check with your local distributor or reseller."},{title:"Does ASTER work with touchscreens and drawing tablets?",content:"ASTER supports most touchscreens and drawing tablets, but compatibility may depend on the device drivers. It is recommended to test your devices during the trial period."},{title:"What are the minimum hardware specification required for 6 workplaces setup?",content:`CPU: Intel Core i7 or AMD Ryzen 7 (with integrated graphics preferred)
Motherboard: Compatible to your choice of CPU (2-3 video ports)
RAM: 16 GB or more (Compatible with the choice of Motherboard)
Storage: 256GB SSD (SSD for OS and program)`},{title:"Can I create a workplace even without a monitor?",content:"Yes, you can create additional workplace with the help of dummy video adapter. These video adapters simulate a monitor and allow it to run headless."},{title:"Can I use ASTER with a touchscreen monitor?",content:"Yes, ASTER can be used with touchscreen monitors. However, the touchscreen functionality may vary depending on the specific monitor and drivers used. It is recommended to test the touchscreen features after setting up ASTER."},{title:"Can I use ASTER with a wireless monitor?",content:"Yes, ASTER can be used with wireless monitors that support Miracast or WiDi technology. However, performance may vary based on the wireless connection quality and monitor specifications."},{title:"Can I use ASTER with a virtual machine?",content:"Yes, ASTER can be used with virtual machines, but performance may vary depending on the virtualization software and hardware resources allocated to the virtual machine."},{title:"What is the baseline PC configuration for 6 users?",content:`The performance of your PC depends on its software.
...
While using Kaspersky Antivirus 2015 it’s necessary to disable self-defense in the antivirus settings additionally.`},{title:"Compatible with external graphics cards",content:"Presently Aster operates with all video cards based on ATI/Nvidia/Intel chipsets. Monitors may be connected also via external USB video adapters on chipsets from FrescoLogic (Win7/8/10) and DispalyLink (Win10 only!), and as a wireless monitor (WiDi) (Miracast/WiDi). Others external USB video adapters as well as software emulations of displays (alike AirDisplay or IDisplay) was not tested."},{title:"Launching Google Chrome, Mozilla Firefox browsers at the extra workplaces",content:`First of all, create a personal account for every computer user. To make it, choose the option “Control panel” at the Start menu, and then click an element “Users’ accounts” twice.
...
* Note: It is recommended to install plugin AdBlock for any browser in order to avoid ads and some other stuff.`},{title:"How do I get remote access to the computer?",content:`1. RDP connection.
...
UltraVNC and similar software allows connecting to working stations independently. However, a further setting of the software might be required in order to be able to use different ports / connection screens, as well as ASTER setting for the application of different IP-аddresses.`},{title:"How to reactivate Aster?",content:`Two ways of Aster reactivation are possible.
...
For a greater number of workplaces you need anyway the preliminary system testing and adjustment. Free downloading the 30-day version of Aster you may here: https://www.ibik.ru/ru/downloads, a tryout version has no functionality restrictions and is limited just by a free to use time.`},{title:"Important notes and known issues (only related to running on Windows 10).",content:`1.Before you enable the ASTER V7 software on Windows 10, it is necessary to extend the desktop on all the displays and set desired resoluiton for each display.
...
`},{title:"Terms of licensing and updating of ASTER",content:`There are different types of licenses for ASTER software:
...
Safe mode reboot options from the working OS are not presented here.`},{title:"Incompatible software.",content:`The software which is incompatible with ASTER can be conveniently divided into two groups:
...
MSI Afterburner
RivaTuner`}];function s(){return e.jsxs("section",{className:"bg-white dark:bg-gray-900 min-h-[calc(100vh-11.75rem)]",children:[e.jsxs("div",{className:"container px-6 py-10 mx-auto",children:[e.jsx("h1",{className:"text-2xl font-semibold text-gray-800 lg:text-3xl dark:text-white",children:"Frequently Asked Questions"}),e.jsxs("div",{class:"flex mx-auto my-6",children:[e.jsx("span",{class:"inline-block w-100 h-1 bg-blue-500 rounded-full"}),e.jsx("span",{class:"inline-block w-3 h-1 mx-1 bg-blue-500 rounded-full"}),e.jsx("span",{class:"inline-block w-1 h-1 bg-blue-500 rounded-full"})]}),e.jsx("div",{class:"space-y-4",children:n.map((t,o)=>e.jsxs("div",{class:"collapse collapse-plus bg-gray-100 rounded-lg dark:bg-gray-800",children:[e.jsx("input",{type:"radio",name:"faqs"}),e.jsx("div",{class:"collapse-title font-semibold text-gray-700 dark:text-white",children:t.title}),e.jsx("div",{class:"collapse-content",children:e.jsx("p",{children:t.content})})]},o))})]}),e.jsx(i,{})]})}export{s as default};
