import{c as r,r as l,j as e}from"./index-DWhQH8N9.js";import{T as m}from"./tag-BxpkiHgV.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],x=r("user",u);function f(){const[a,o]=l.useState("all"),n=[{id:"all",name:"All Posts"},{id:"news",name:"News"},{id:"tutorials",name:"Tutorials"},{id:"updates",name:"Updates"},{id:"tips",name:"Tips & Tricks"}],s=[{id:1,title:"ASTER v2.60.0 Released: Major Update with New Features",category:"updates",date:"2024-03-18",author:"ASTER Team",content:`ASTER v2.60.0 brings significant improvements to multi-user computing. Key features include:
