import{r as s,j as e}from"./index-DK--aQlE.js";import{D as r}from"./Download-CZN9J92b.js";import{M as l,P as c}from"./plus-BkZq-opj.js";const h=[{question:"How do I know if my computer support creating multiple workplace?",answer:"Does your computer have additional video port to connect an additional monitor or TV ? Then yes, you can create additional workplace from your computer."},{question:"Is Windows 10 operating system supported by ASTER?",answer:"Yes, ASTER support Windows 7/8/10/11, Windows Server 2016/2019/2022/2025. However, ASTER doesnot support any preview builds of for Windows and Windows Server"},{question:"How many users can ASTER support?",answer:"ASTER can support up to 12 users simultaneously, depending on the hardware configuration and available resources."},{question:"What are the system requirements for ASTER?",answer:'ASTER requires a Windows operating system (Windows 7/8/10/11, Windows Server 2016/2019/2022/2025) and a compatible hardware configuration that includes a CPU, RAM, and video outputs to connect multiple monitors. For detailed requirements, please refer to the "System Requirements" section in the ASTER documentation.'},{question:"How do I install ASTER?",answer:"To install ASTER, download the installation package from the official website, run the installer, and follow the on-screen instructions. Make sure to have administrative privileges during installation."},{question:"Can I use ASTER with virtual machines?",answer:"Yes, ASTER can be used with virtual machines, but performance may vary depending on the virtualization software and hardware resources allocated to the virtual machine."},{question:"How do I configure ASTER for multiple users?",answer:"After installing ASTER, you can configure it for multiple users by accessing the ASTER Control Panel. From there, you can add additional users, assign monitors to each user, and customize settings for each workplace."},{question:"What is the difference between ASTER Pro and ASTER Annual licenses?",answer:"ASTER Pro is designed for professional use with advanced features and support for more users, while ASTER Home is intended for personal use with basic features and a limited number of users."},{question:"How do I troubleshoot common issues with ASTER?",answer:'Common issues with ASTER can often be resolved by checking the hardware connections, ensuring that the video drivers are up to date, and reviewing the settings in the ASTER Control Panel. For specific troubleshooting steps, refer to the "Troubleshooting" section in the ASTER documentation.'},{question:"How do I get support for ASTER?",answer:"You can get support for ASTER by visiting the official website and accessing the support section. There, you can find documentation, FAQs, and contact information for technical support."},{question:"Can I use ASTER with different types of monitors?",answer:"Yes, ASTER supports various types of monitors, including LCD, LED, and CRT monitors. However, it is recommended to use monitors with compatible resolutions and refresh rates for optimal performance."},{question:"How do I activate ASTER?",answer:'To activate ASTER, you need to enter the activation key provided with your purchase. This can be done through the ASTER Control Panel under the "Activation" section. Make sure you have an internet connection during the activation process.'},{question:"Can I use ASTER on a laptop?",answer:"Yes, ASTER can be used on laptops, but it is important to ensure that the laptop has sufficient hardware resources and video outputs to support multiple monitors."},{question:"What is the maximum number of monitors that can be connected with ASTER?",answer:"The maximum number of monitors that can be connected with ASTER depends on the hardware configuration and the number of available video outputs. Typically, ASTER supports up to 12 monitors, but this may vary based on the specific setup."},{question:"Can I use ASTER with remote desktop applications?",answer:"Yes, ASTER can be used with remote desktop applications, allowing users to access their workplaces remotely while maintaining the multi-user functionality."},{question:"How do I uninstall ASTER?",answer:'To uninstall ASTER, go to the Control Panel, select "Programs and Features," find ASTER in the list of installed programs, and click "Uninstall." Follow the prompts to complete the uninstallation process.'},{question:"Is there a trial version of ASTER available?",answer:"Yes, a trial version of ASTER is available for download from the official website. The trial version allows you to test the software with limited features for a specified period."},{question:"Is it easy to setup?",answer:"ASTER has a wizard which starts once you have installed ASTER, which will help you to setup the workplaces."},{question:"How can I transfer the license to another computer?",answer:"You should perform the deactivation procedure from ASTER Control to deactivate the license. Once deactivation has been confirmed in ASTER Control, you will get a new key to use on your new computer."},{question:"Can I use ASTER for gaming setups?",answer:"Yes, ASTER can be used for gaming setups where multiple users want to play games on the same PC. However, performance will depend on your hardware resources, especially the graphics card and CPU. Some games may require additional configuration for controllers or network settings."},{question:"Does ASTER support audio separation for each workplace?",answer:"Yes, ASTER supports audio separation. You can assign different audio devices (such as USB sound cards or headsets) to each workplace, allowing each user to have independent audio output."},{question:"Can I use different languages or keyboard layouts for each workplace?",answer:"Yes, each workplace can have its own language and keyboard layout settings. Configure these in the Windows settings for each user account."},{question:"Is there a limit to the number of USB devices per workplace?",answer:"There is no strict software limit, but the number of USB devices per workplace is limited by your hardware (number of USB ports and controllers). Each workplace can use its own keyboard, mouse, and other USB peripherals."},{question:"Can I use ASTER in a school or classroom environment?",answer:"Yes, ASTER is widely used in schools, classrooms, and training centers to maximize computer usage and reduce costs. Each student can have their own workplace using a single PC."},{question:"How do I update ASTER to the latest version?",answer:"To update ASTER, download the latest installer from the official website and run it. Your license will remain valid if you are within the free upgrade period or have purchased an upgrade license."},{question:"What happens if my hardware changes after activation?",answer:"Significant hardware changes (such as replacing the motherboard or CPU) may require reactivation of your ASTER license. Use the deactivation feature before making hardware changes, or contact support if you are unable to deactivate in advance."},{question:"Can I use ASTER with macOS or Linux?",answer:"No, ASTER is designed for Windows operating systems only. But, recently we have added support for some linux distribution like Ubuntu, Debian, Fedora, etc."},{question:"Is technical support available in languages other than English?",answer:"Technical support is primarily provided in English and Russian. User interface is available in multiple languages. For other languages, please check with your local distributor or reseller."},{question:"Does ASTER work with touchscreens and drawing tablets?",answer:"ASTER supports most touchscreens and drawing tablets, but compatibility may depend on the device drivers. It is recommended to test your devices during the trial period."},{question:"What are the minimum hardware specification required for 6 workplaces setup?",answer:`CPU: Intel Core i7 or AMD Ryzen 7 (with integrated graphics preferred)
Motherboard: Compatible to your choice of CPU (2-3 video ports)
RAM: 16 GB or more (Compatible with the choice of Motherboard)
Storage: 256GB SSD (SSD for OS and program)`},{question:"Can I create a workplace even without a monitor?",answer:"Yes, you can create additional workplace with the help of dummy video adapter. These video adapters simulate a monitor and allow it to run headless."},{question:"Can I use ASTER with a touchscreen monitor?",answer:"Yes, ASTER can be used with touchscreen monitors. However, the touchscreen functionality may vary depending on the specific monitor and drivers used. It is recommended to test the touchscreen features after setting up ASTER."},{question:"Can I use ASTER with a wireless monitor?",answer:"Yes, ASTER can be used with wireless monitors that support Miracast or WiDi technology. However, performance may vary based on the wireless connection quality and monitor specifications."},{question:"Can I use ASTER with a virtual machine?",answer:"Yes, ASTER can be used with virtual machines, but performance may vary depending on the virtualization software and hardware resources allocated to the virtual machine."},{question:"What is the baseline PC configuration for 6 users?",answer:`The performance of your PC depends on its software.
...
This is an approximate configuration for assembling the desktop tower with the possibility of connecting six monitors.`},{question:"Antiviruses compatibility",answer:`General recommendations: install antiviruses while ASTER program is turned off, with mandatory reboot, and it is desirable only for the account of the first workplace.
...
In order antivirus has not been blocking ASTER program working, add the folder with the installed ASTER to the exception - C:WINDOWSsystem32mute32.dll for WinXP, C:WINDOWSSystem32driversmutenx.sys for Win7/8.

While using Kaspersky Antivirus 2015 it’s necessary to disable self-defense in the antivirus settings additionally.`},{question:"Compatible with external graphics cards",answer:"Presently Aster operates with all video cards based on ATI/Nvidia/Intel chipsets. Monitors may be connected also via external USB video adapters on chipsets from FrescoLogic (Win7/8/10) and DispalyLink (Win10 only!), and as a wireless monitor (WiDi) (Miracast/WiDi). Others external USB video adapters as well as software emulations of displays (alike AirDisplay or IDisplay) was not tested."},{question:"Launching Google Chrome, Mozilla Firefox browsers at the extra workplaces",answer:`First of all, create a personal account for every computer user. To make it, choose the option “Control panel” at the Start menu, and then click an element “Users’ accounts” twice.
...
* Note: It is recommended to install plugin AdBlock for any browser in order to avoid ads and some other stuff.`},{question:"How do I get remote access to the computer?",answer:`1. RDP connection.
...
UltraVNC and similar software allows connecting to working stations independently. However, a further setting of the software might be required in order to be able to use different ports / connection screens, as well as ASTER setting for the application of different IP-аddresses.`},{question:"How to reactivate Aster?",answer:`Two ways of Aster reactivation are possible.
...
For a greater number of workplaces you need anyway the preliminary system testing and adjustment. Free downloading the 30-day version of Aster you may here: https://www.ibik.ru/ru/downloads, a tryout version has no functionality restrictions and is limited just by a free to use time.`},{question:"Important notes and known issues (only related to running on Windows 10).",answer:`1.Before you enable the ASTER V7 software on Windows 10, it is necessary to extend the desktop on all the displays and set desired resoluiton for each display.
...
`},{question:"Terms of licensing and updating of ASTER",answer:`There are different types of licenses for ASTER software:
...
2. Software reactivation in cases when deactivation is not required (for example, after reinstallation of operating system on the same HDD) may be carried out as many times as you wish using the available key (i.e. the same as during the first ASTER installation).`},{question:"Why do the working stations have identical desktops?",answer:"Personalization parameters are not linked with the working station and can be adjusted individually for each user account. Therefore, if you wish to have individual personalization settings, use a separate user account for each working station."},{question:"How can a workplace be made without the monitor?",answer:"To run workplaces you have to link a monitor. However you may simulate a connected monitor by means of a dummy panel, or if the monitor has several interfaces (for example, VGA+DVI), you may connect one monitor several times, in doing so you may switch between workplaces just by selecting a required signal on the monitor."},{question:"How can to assign several monitors to one working station?",answer:`In order to assign several monitors to one working station, you have to use a separate graphic card for it, as a working station with several monitors cannot share its graphic cards with another working station. However, NVIDIA Surround and AMD Eyefinity technologies give us a possibility to use extra monitors for a working station on the shared video card, and the working station can use only the monitors with the shared video card.

These technologies allow uniting several monitors, with the system treating it as one monitor, which might be assigned to one of the working stations in ASTER settings. However, one has to realize that the monitors, “grouped” in this way, present a single continuous screen and, consequently, cannot work in different modes.`},{question:"Troubleshooting",answer:`Troubles with the PC operation, for instance, BSOD / freeze at the OS start or a blank black screen when turning on the PC, can be repaired in the following ways.
...
Safe mode reboot options from the working OS are not presented here.`},{question:"Incompatible software.",answer:`The software which is incompatible with ASTER can be conveniently divided into two groups:
...
MSI Afterburner
RivaTuner`}];function m(){const[a,i]=s.useState(null),n=t=>{i(a===t?null:t)};return e.jsxs("section",{className:"bg-white dark:bg-gray-900 min-h-[calc(100vh-11.75rem)]",children:[e.jsxs("div",{className:"container px-6 py-10 mx-auto",children:[e.jsx("h1",{className:"text-2xl font-semibold text-gray-800 lg:text-3xl dark:text-white",children:"FAQ's"}),e.jsx("hr",{className:"my-6 border-gray-200 dark:border-gray-700"}),e.jsx("div",{className:"space-y-4",children:h.map((t,o)=>e.jsxs("div",{className:"border-b border-gray-200 dark:border-gray-700 pb-4",children:[e.jsxs("button",{className:"flex items-center w-full text-left focus:outline-none",onClick:()=>n(o),children:[a===o?e.jsx(l,{className:"flex-shrink-0 w-6 h-6 text-blue-500"}):e.jsx(c,{className:"flex-shrink-0 w-6 h-6 text-blue-500"}),e.jsx("h2",{className:"mx-4 text-xl text-gray-700 dark:text-white",children:t.question})]}),a===o&&e.jsxs("div",{className:"flex mt-4 md:mx-10",children:[e.jsx("span",{className:"border-l-2 border-blue-500 mr-4"}),e.jsx("div",{className:"prose max-w-none mb-4",children:e.jsx("div",{className:"whitespace-pre-wrap",children:t.answer})})]})]},o))})]}),e.jsx(r,{})]})}export{m as default};
